...
pub fn payload_fields_for_event(event_ident: &str) -> Option<Vec<(&'static str, bool)>> {
    let map: HashMap<&str, Vec<(&str, bool)>> = [
        ...
        // Module lifecycle
        ("ModuleLoaded", vec![("module_name", false), ("version", false)]),
        ("ModuleUnloaded", vec![("module_name", false), ("version", false)]),
        ("ModuleReloaded", vec![
            ("module_name", false),
            ("old_version", false),
            ("new_version", false),
        ...
        ("BlockTemplateUpdated", vec![
            ("prev_hash", false),
            ("height", true),
            ("tx_count", true),
        ]),
        ("MiningDifficultyChanged", vec![
            ("old_difficulty", true),
            ("new_difficulty", true),
            ("height", true),
        ]),
        ("MiningJobCreated", vec![
            ("job_id", false),
            ("prev_hash", false),
            ("height", true),
        ]),
        ...
        ("MergeMiningReward", vec![
            ("secondary_chain", false),
            ("reward_amount", true),
            ("block_hash", false),
        ]),
        ("MiningPoolConnected", vec![("pool_url", false), ("pool_id", false)]),
        ("MiningPoolDisconnected", vec![("pool_url", false), ("reason", false)]),
        // Network
        ("PeerConnected", vec![
            ("peer_addr", false),
        ...
        ("PeerDisconnected", vec![("peer_addr", false), ("reason", false)]),
        ("PeerBanned", vec![
            ("peer_addr", false),
            ("reason", false),
        ...
        // Mempool
        ("MempoolTransactionAdded", vec![
            ("tx_hash", false),
            ("fee_rate", true),
            ("mempool_size", true),
        ]),
        ("MempoolTransactionRemoved", vec![
            ("tx_hash", false),
            ("reason", false),
            ("mempool_size", true),
        ]),
        ...
        // Node lifecycle
        ("NodeStartupCompleted", vec![("duration_ms", true), ("components", false)]),
        ("NodeShutdownCompleted", vec![("duration_ms", true)]),
        ("NodeShutdown", vec![("reason", false), ("timeout_seconds", true)]),
        ("ConfigLoaded", vec![("changed_sections", false), ("config_json", false)]),
        // Maintenance
        ("DataMaintenance", vec![
            ("operation", false),
            ("urgency", false),
